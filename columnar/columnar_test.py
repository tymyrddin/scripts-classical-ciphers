...
def main():
    ...
    for i in range(20):  # run 20 tests
        ...
        for key in range(1, int(len(message) / 2)):
            encrypted = columnar_encrypt.encrypt_message(key, message)
            decrypted = columnar_decrypt.decrypt_message(key, encrypted)
...
# If columnar_test.py is run (instead of imported as a module) call
# the main() function.
